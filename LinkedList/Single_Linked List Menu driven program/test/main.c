...
{ head=0;
    ...
    int c,pos,pos2;
        ...
        case 3:
           ...
           {
               printf("The position you entered is invalid,please enter correct position: ");
               scanf("%d",&pos);
        ...
        case 12:
            ...
            {
                printf("Swapping can only occur..when more than one node is present..\n");
